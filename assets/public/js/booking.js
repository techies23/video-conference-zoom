...
(function () {
  const vczapiBooking = (container, flatpickrOptions = {}) => {
    ...
    const globalParams = vczapiMeetingBookerParams ?? {
      ajaxURL: ''
    };
    ...
    const DOM = {
      container: null,
      form: null,
      dateInput: null // BEM-friendly: e.g., .vczapi-booking__date
    };
    const SELECTORS = {
      form: 'form',
      dateInput: '.vczapi-meeting-booker__date-input',
