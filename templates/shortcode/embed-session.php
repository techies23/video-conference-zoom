...
if ( isset( $zoom->zoom_states[ $meeting_id ]['state'] ) && $zoom->zoom_states[ $meeting_id ]['state'] == "ended" ) {
    ...
    <div class="vczapi-jvb-countdown-wrapper">
        <h3 class="vczapi-jvb-countdown-wrapper-countdown-title">Meeting starts in:</h3>
    ...
    <div class="vczapi-jvb-countdown-content">
        ...
        <div class="vczapi-jvb-countdown-content-contents">
            <div class="vczapi-jvb-countdown-content-description">
                ...
                <div class="vczapi-jvb-countdown-content-description-time"><strong>Start Time:</strong> <?php echo vczapi_dateConverter( $zoom->start_time, $zoom->timezone, true ); ?></div>
                <div class="vczapi-jvb-countdown-content-description-timezone"><strong>Timezone:</strong> <?php echo $zoom->timezone; ?></div>
                <div class="vczapi-jvb-countdown-content-description-timezone"><strong>Password:</strong> <?php echo $zoom->password; ?></div>
            </div>
            <div class="vczapi-jvb-countdown-content-links">
                <a class="btn btn-join-link btn-join-via-app" href="<?php echo $join_via_browser_link; ?>">Join via Browser</a>
