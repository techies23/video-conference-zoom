...
class Meetings
{
    ...
    public function list_live_host_meetings($atts)
    {
        ...
        ob_start();
        vczapi_get_template('shortcode/list-meetings-host.php', true, false, $meetings);

        return ob_get_clean();
    }

    /**
     * Show Meeting based on option selected
     *
     * @param $atts
     *
     * @return bool|false|string|void
     ...
     * @since  3.6.4
     */
    public function show_meeting_by_optionSelected($atts)
    {
        extract(shortcode_atts(array(
            'post_id' => '',
            'template' => '',
