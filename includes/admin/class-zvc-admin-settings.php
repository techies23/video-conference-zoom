...
class Zoom_Video_Conferencing_Admin_Views {
	...
	public function zoom_video_conference_api_zoom_settings() {
		...
		$active_tab = isset( $tab ) ? $tab : 'api';
		?>
        <div class="wrap">
            <h1><?php _e( 'Zoom Integration Settings', 'video-conferencing-with-zoom-api' ); ?></h1>
            <h2 class="nav-tab-wrapper">
                <a href="<?php echo add_query_arg( array( 'tab' => 'api' ) ); ?>" class="nav-tab <?php echo ( 'api' === $active_tab ) ? esc_attr( 'nav-tab-active' ) : ''; ?>">
					<?php esc_html_e( 'Connect', 'video-conferencing-with-zoom-api' ); ?>
                </a>
                <a href="<?php echo add_query_arg( array( 'tab' => 'settings' ) ); ?>" class="nav-tab <?php echo ( 'settings' === $active_tab ) ? esc_attr( 'nav-tab-active' ) : ''; ?>">
			...
			if ( 'api' === $active_tab ) {
				if ( isset( $_POST['save_zoom_api_connection'] ) ) {
					//Nonce
				...
				//Get Template
				require_once ZVC_PLUGIN_VIEWS_PATH . '/tabs/connection.php';
				...
				require_once ZVC_PLUGIN_VIEWS_PATH . '/tabs/settings.php';
