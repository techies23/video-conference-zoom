...
class WebinarList extends Widget_Base {
	...
	protected function render() {
		...
		echo do_shortcode( '[zoom_list_webinars ' . $author_id . ' show_on_past="' . esc_attr( $show_on_past ) . '" filter="' . esc_attr( $filter ) . '" per_page="' . esc_attr( $count ) . '" category="' . esc_attr( $category ) . '" order="' . esc_attr( $order ) . '" type="' . esc_attr( $type ) . '"]' );
	}
