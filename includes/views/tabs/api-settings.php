        ...
        <form action="edit.php?post_type=zoom-meetings&page=zoom-video-conferencing-settings&tab=api-settings"
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox"
                               name="donot_delete_zom_meeting_also" <?php ! empty( $donot_delete_zoom ) ? checked( $donot_delete_zoom, 'on' ) : false; ?>>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox"
                               name="disable_auto_pwd_generation" <?php ! empty( $disable_auto_pwd_generation ) ? checked( $disable_auto_pwd_generation, 'on' ) : false; ?>>
                ...
                <tr>
                    <th><label><?php _e( 'Disable Moment JS?', 'video-conferencing-with-zoom-api' ); ?></label></th>
                    <td>
                        <input type="checkbox"
                               name="zoom_api_disable_moment_js" <?php echo ! empty( $disable_moment_js ) ? checked( $disable_moment_js, 'on' ) : false; ?>
                               class="form-control">
                        <span class="description"><?php _e( 'DO NOT CHECK THIS UNLESS - you have a "guess" conflict on your console when you view single meetings page then that\'s probably because some other plugin is using the same script. So, check this when this happens and see if it fixes anything.', 'video-conferencing-with-zoom-api' ); ?></span>
                    </td>
                </tr>
                <tr>
            ...
            <h3 class="description"
                style="color:red;"><?php _e( 'After you enter your keys. Do save changes before doing "Check API Connection".', 'video-conferencing-with-zoom-api' ); ?></h3>
            <p class="submit">
