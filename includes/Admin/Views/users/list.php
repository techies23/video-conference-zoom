...
<div class="wrap vczapi-users">
    <div class="vczapi-users__header">
        <h1 class="wp-heading-inline vczapi-users__title"><?php esc_html_e( "Zoom Users", "video-conferencing-with-zoom-api" ); ?></h1>
    </div>

    <div class="vczapi-users__actions">
        <a href="?post_type=zoom-meetings&page=zoom-video-conferencing-list-users&status=pending" class="vczapi-users__action-link">
            <?php esc_html_e( 'Check Pending Users', 'video-conferencing-with-zoom-api' ); ?>
        </a>
    </div>
