...
import previewImage from './list-meetings-webinars.png'
...
export default function EditListMeetingsWebinars(props) {
    ...
    if (preview) {
        return <img src={previewImage} alt={"Preview Image for List Meetings"} className="vczapi-blocks__preview-image"/>
    }
