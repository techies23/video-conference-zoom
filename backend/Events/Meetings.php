...
namespace Codemanas\VczApi\Backend\Events;

/**
 * Class Events
 * @since 1.0.0
 * @updated 4.0.0
 * @package Codemanas\VczApi\Backend\Events
 */
class Meetings {
	...
	public static function list_meetings() {
		...
		//Get Template
		require_once VCZAPI_BACKEND_PATH . '/Events/views/meetings/tpl-list-meetings.php';
	}
	...
	public static function add_meeting() {
		...
		if ( isset( $_GET['edit'] ) && isset( $_GET['host_id'] ) ) {
			...
			//Get Editin Template
			require_once VCZAPI_BACKEND_PATH . '/Events/views/meetings/tpl-edit-meeting.php';
		} else {
			...
			//Get Template
			require_once VCZAPI_BACKEND_PATH . '/Events/views/meetings/tpl-add-meetings.php';
		}
	}
	...
	private static function update_meeting() {
		...
		$meeting_updated = zoom_conference()->updateMeetingInfo( $update_meeting_arr );
