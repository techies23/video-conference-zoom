...
<div class="vczapi-row">
    <div class="col-9">
        <div class="vczapi-white-background">
            <form action="edit.php?post_type=zoom-meetings&page=zoom-video-conferencing-settings&tab=general" method="POST">
    ...
    <div class="col-3">
        <ul class="vczapi-white-background">
            <li>
        ...
        <div class="vczapi-white-background">
            ...
            <p>Integrate your Zoom Meetings directly to WooCommerce products sending zoom links to direct emails or user account dashboard.</p>
            <p><a href="https://www.codemanas.com/downloads/zoom-meetings-for-woocommerce/" class="button button-primary">More Details</a>
            </p>
        </div>
        <div class="vczapi-white-background">
